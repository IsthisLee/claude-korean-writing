...
프롬프트로 그때그때 막으려면 세션마다 다시 붙여야 합니다. 다 쓴 글을 나중에 다듬게 해도 크게 달라지지 않습니다. 실제로 다듬게 해 보니 바뀐 부분이 많아야 글의 18%였고 한 글자도 바뀌지 않은 공지도 있었습니다. 같은 요청을 처음부터 규칙대로 쓴 글과 다 쓰고 다듬은 글로 56번 견줘 보니 어느 쪽인지 모르는 AI 판정자가 처음부터 쓴 글을 49번 골랐고 다듬은 글을 고른 적은 없었습니다. 그래서 글이 만들어지는 시점을 셋으로 나누고 시점마다 하나씩 맡겼습니다. 설치하면 셋이 함께 켜지고 무엇을 언제 부를지 외울 일은 없습니다.
