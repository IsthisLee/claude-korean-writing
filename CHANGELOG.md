...
- **README 맨 위를 배너 대신 한 장짜리 그림으로 바꿨습니다.** Claude Code가 실제로 쓴 문장과 규칙대로 고친 문장을 규칙 코드와 함께 큰 글씨로 보여 주고 쓸 때·저장할 때·다 쓴 뒤 세 시점을 아래에 둡니다. `tools/render-hero.py` 가 한국어·영어, 어두운 테마·밝은 테마 네 장을 그리고 왼쪽 문장이 정답 데이터에 없으면 멈춥니다. 옛 배너 넷은 지웠습니다
