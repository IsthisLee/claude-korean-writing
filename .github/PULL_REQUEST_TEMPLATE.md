...
- [ ] `scripts/check.sh <고친 .md 파일>`

## 판정 규칙(K1~K8)을 바꿨다면

<!-- 규칙을 안 건드렸으면 이 절은 지우세요. -->

- [ ] `scripts/measure.sh` 로 실제 문서에 돌린 결과를 아래에 적었습니다
- [ ] `hooks-handlers/test_posttooluse.py` 에 회귀 테스트를 넣었습니다
...
- [ ] 가져온 파일을 고쳤다면 `NOTICE.md` 의 수정 범위도 고쳤습니다
