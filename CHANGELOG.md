...
- **목적을 "Claude Code 가 쓰는 모든 한국어" 로 넓혔습니다.** 이전에는 밖으로 나갈 글과 `.md` 편집만 맡아서, 가장 양이 많은 평소 답변이 비어 있었습니다. README 에 어느 자리를 맡고 어느 자리를 안 맡는지 적은 표를 넣었습니다
- EVALUATION.md 의 D2 예산을 상시 500 토큰에서 1,000 토큰으로 올렸습니다. 상시 규칙 659 토큰이 들어가면서 합계가 약 930 이 됩니다. 시험한 규칙을 그대로 넣고 예산을 다시 잡았습니다
